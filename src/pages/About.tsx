  ...
  const values = [
    {
      ...
      title: 'Our Mission',
      titleFa: 'ماموریت ما',
      description: 'To democratize access to global higher education by connecting ambitious students with life-changing opportunities worldwide.',
      descriptionFa: 'دموکراتیک کردن دسترسی به آموزش عالی جهانی از طریق اتصال دانشجویان جاه‌طلب با فرصت‌های تغییردهنده زندگی در سراسر جهان.'
    },
    {
      icon: Heart,
      title: 'Our Values',
      titleFa: 'ارزش‌های ما',
      description: 'We believe in equality, transparency, and personalized support. Every student deserves the chance to pursue their dreams.',
      descriptionFa: 'ما به برابری، شفافیت و پشتیبانی شخصی‌سازی شده اعتقاد داریم. هر دانش‌آموز شایسته فرصت دنبال کردن رؤیاهایش است.'
    },
    {
      icon: Users,
      title: 'Our Team',
      titleFa: 'تیم ما',
      description: 'A diverse group of educators, technologists, and former international students who understand your journey.',
      descriptionFa: 'گروهی متنوع از مربیان، فناوران و دانشجویان بین‌المللی سابق که سفر شما را درک می‌کنند.'
    }
  ];
