...
export const LandingHero = () => {
  ...
  return (
    <section
      className={`relative bg-gradient-to-br from-primary/5 to-success/5 py-20 ${
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="relative flex items-center">
              <Input
                ...
                } rounded-full border-2 border-gray-200 focus:border-primary`}
              ...
              <Button
                ...
                } h-10 px-6 bg-primary hover:bg-primary/90 rounded-full`}
              >
                {t("hero.cta")}
              </Button>
            </div>
